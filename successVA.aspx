<%@ Page Title="" Language="C#" MasterPageFile="~/first.master" AutoEventWireup="true" CodeBehind="successVA.aspx.cs" Inherits="CapstoneFinal.successVA" %>
<asp:Content ID="Content1" ContentPlaceHolderID="nestedFirst" runat="server">
    ...
    <div style="text-align:center;  margin:auto;">
        ...
        <fieldset style="width:400px; margin:auto; border-color: #AD9C65; padding: 20px;" >
            ...
            <br />
            <asp:Label ID="lblCode" runat="server" Text="Volunteer Successfully Added!" style="color:#450084; font-size:larger;"></asp:Label>
            <br />
            <br />
